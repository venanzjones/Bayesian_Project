...
static constexpr std::array<const char*, 35> locations_array__ =
  ...
  " (in 'base.stan', line 33, column 4 to column 25)",
...
class base_model final : public model_base_crtp<base_model> {
 ...
 public:
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"beta", "xi"};
    if (emit_transformed_parameters__) {
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (P + nyears);
